...
import { Dialog, DialogActions, DialogTitle, DialogContent, DialogContentText, TextField, Button, CircularProgress, InputAdornment, IconButton, Grid, Typography } from '@mui/material';
...
function LoginDialog(props) {
  ...
  return (
      <Dialog open={props.loginOpen} onClose={handleClose} maxWidth="xs" fullWidth component={motion.div} initial={{ y: "-100vh" }} animate={{ y: 0 }} exist={{ y: "-100vh" }} >
        ...
        <DialogContent >
          <Typography>Oops! You have to sign in to do that!</Typography>
